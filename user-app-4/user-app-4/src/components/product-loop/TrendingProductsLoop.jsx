...
// console.log('products print', user);
    ...
    return (
        <>
            {trendingProducts.length == 0 && <div><span style={{textAlign: 'center', color: 'black', fontSize: 30}}>No products found</span></div>}
...
export default TrendingProductsLoop
